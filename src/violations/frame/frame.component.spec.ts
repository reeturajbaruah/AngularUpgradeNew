...
describe('component: violations-frame', () => {
    ...
    describe('setTitle', () => {
        ...
        it('should set uiRouterGlobals.current.data.title to title', async () => {

            uiRouterGlobals.current.data.title = 'fake initial value';

            component.setTitle('some title we want to set');

            expect(uiRouterGlobals.current.data.title).toBe('some title we want to set');
        });
    });
