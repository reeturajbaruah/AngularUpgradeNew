...
import { IInjectionValues } from './overpayment/interfaces/injectionvalues.interface';
...
describe('component: violations-invoiced-row', () => {
    ...
    describe('showOverPaymentModal', () => {
        it('should call matDialog.open() 1 times', () => {
            ...
            const expectedsettings: MatDialogConfig<IInjectionValues> = {
                data: {
                    cmsContent: {
                        Title: 'fake title',
                        PrimaryContent: 'fake PrimaryContent'
            ...
            expect(dialog.open).toHaveBeenCalledWith(OverpaymentComponent, expectedsettings);
        });
    });
    ...
    describe('ngOnChanges', () => {
        it('should call checkBoxChange() if isChecked changes in reference to the value of the invoiced', () => {
            ...
            component.invoiced = { checked: false } as IViolationInvoice & ISelectable;
    ...
    describe('openTollDetailsModal', () => {
        it('should call dialogService', () => {
            ...
            expect(dialogService.openSliderFilled).toHaveBeenCalledWith(InvoicedDetailsComponent,
                { invoiced: component.invoiced, plate: component.plate, isPreviousPaid: false, isSuspendedAccount: undefined },
