...
describe('component: violations-uninvoiced-row', () => {
    ...
    beforeEach(async () => {
        ...
        environmentConfig = jasmine.createSpyObj('environmentConfig', [], ['isMergeMATandVioOn']);
    ...
    describe('ngOnChanges', () => {
        it('should call checkBoxChange() if isChecked changes in reference to the value of the uninvoiced', () => {
            ...
            component.uninvoiced = { checked: false } as IViolation & ISelectable;
    ...
    describe('openTollDetailsModal', () => {
        beforeEach(() => {
            (Object.getOwnPropertyDescriptor(environmentConfig, 'isMergeMATandVioOn').get as jasmine.Spy).and.returnValue(false);
