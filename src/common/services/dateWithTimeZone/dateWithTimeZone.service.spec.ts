...
import { DateWithTimeZoneService } from './dateWithTimeZone.service';

describe('DateWithTimeZoneService', () => {
  let service: DateWithTimeZoneService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [DateWithTimeZoneService]
    });
    service = TestBed.inject(DateWithTimeZoneService);
  });
