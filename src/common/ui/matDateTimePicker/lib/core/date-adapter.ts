...
export abstract class HctraMatDateAdapter<D> extends DateAdapter<D> {
    /**
     ...
     * @param b Date 2
     */
    public isSameTime(a: D, b: D): boolean {
        if (a == null || b == null) {
            return true;
        }
     ...
     * @param fromDate 
     */
    public copyTime(toDate: D, fromDate: D) {
     ...
     */
    public compareDateWithTime(first: D, second: D, showSeconds?: boolean): number {
     ...
     */
    public setTimeByDefaultValues(date: D, defaultTime: number[]) {
